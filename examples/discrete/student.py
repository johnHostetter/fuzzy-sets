...
from fuzzy_sets.discrete import DiscreteFuzzySet, FuzzyVariable
...
if __name__ == "__main__":
    ...
    fuzzy_variable.plot(samples=150).show()
    ...
    alpha_cut.plot(samples=250).show()
    special_fuzzy_set = SpecialFuzzySet(known(), 0.5, "Special")
    special_fuzzy_set.plot().show()
